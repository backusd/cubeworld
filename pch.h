...
#define NOSERVICE
#define NOSOUND
//#define NOTEXTMETRIC	--> Causes build to fail when d3d10_1.h and d3dx10.h are included
#define NOWH
#define NOCOMM
#define NOKANJI
#define NOHELP
...
#include <mmsystem.h>	// --> Required for timeGetTime() (Should be removed once we incorporate a better timing mechanism)
